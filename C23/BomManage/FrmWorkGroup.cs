...
namespace C23.BomManage
{
    public partial class FrmWorkGroup : Form
    {
        ...
        protected string M_str_sql = "select WGID AS 组代码,WorkGroup as 工作组,Maker as 制单人,Date as 日期 from tb_WorkGroup";
        protected string M_str_table = "tb_WorkGroup";
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox1.Controls.Add(this.txtWorkGroupID);
            this.groupBox1.Controls.Add(this.txtWorkGroup);
            ...
            // txtWorkGroupID
            // 
            this.txtWorkGroupID.Location = new System.Drawing.Point(103, 32);
            this.txtWorkGroupID.Name = "txtWorkGroupID";
            this.txtWorkGroupID.ReadOnly = true;
            this.txtWorkGroupID.Size = new System.Drawing.Size(100, 21);
            this.txtWorkGroupID.TabIndex = 11;
            // 
            // txtWorkGroup
            // 
            this.txtWorkGroup.Location = new System.Drawing.Point(280, 32);
            this.txtWorkGroup.Name = "txtWorkGroup";
            this.txtWorkGroup.Size = new System.Drawing.Size(192, 21);
            this.txtWorkGroup.TabIndex = 6;
            // 
            // label1
            // 
        ...
        private void save()
        {
            ...
            {
                MessageBox.Show("工作组不能为空！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else if (txtWorkGroupID.Text == "")
            {
                MessageBox.Show("组代码不能为空！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                if (M_int_judge == 0)
                {
                    dt1 = boperate.getdt("select WorkGroup from tb_WorkGroup where WorkGroup='" + txtWorkGroup.Text + "'");
                    if (dt1.Rows.Count > 0)
                    {
                        MessageBox.Show("工作组已经存在！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        boperate.getcom("insert into tb_WorkGroup(WGID,WorkGroup,Maker,Date,Year,Month,Day) values('" + txtWorkGroupID.Text + "','"
                                           + txtWorkGroup.Text.Trim() + "','" + FrmLogin.M_str_name +
                ...
                {
                    dt2 = boperate.getdt("select WorkGroup from tb_WorkGroup");
                    if (dt2.Rows.Count > 0)
                    {
                        boperate.getcom(@"update tb_WorkGroup set WorkGroup='" + txtWorkGroup.Text + "',Maker='" + FrmLogin.M_str_name +
                         "',Date='" + varDate + "' where WGID='" + Convert.ToString(dataGridView1[0, dataGridView1.CurrentCell.RowIndex].Value).Trim() + "'");
                        Bind();
                    }
                    else
                    {
        ...
        {
            txtWorkGroup.Text = Convert.ToString(dataGridView1[0, dataGridView1.CurrentCell.RowIndex].Value).Trim();
            txtWorkGroup.Text = Convert.ToString(dataGridView1[1, dataGridView1.CurrentCell.RowIndex].Value).Trim();
        }
        ...
        {
            string a1 = boperate.numN(12, 4, "0001", "select * from tb_WorkGroup", "WGID", "WG");
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataSet myds = boperate.getds(M_str_sql + " where WorkGroup like '%" + txtKeyWord.Text.Trim() + "%' order by Date asc", M_str_table);
