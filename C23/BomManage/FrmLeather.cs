...
{
    public partial class FrmLeather : Form
    {
        ...
        protected string M_str_sql = "select Leather as 皮种,Maker as 制单人,Date as 日期 from tb_Leather";
        protected string M_str_table = "tb_Leather";
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmLeather));
            this.dataGridView1 = new System.Windows.Forms.DataGridView();
            this.groupBox1 = new System.Windows.Forms.GroupBox();
            this.txtLeather = new System.Windows.Forms.TextBox();
            ...
            this.groupBox1.Controls.Add(this.txtLeather);
            ...
            this.groupBox1.Text = "皮种信息";
            // 
            // txtLeather
            // 
            this.txtLeather.Location = new System.Drawing.Point(81, 20);
            this.txtLeather.Name = "txtLeather";
            this.txtLeather.Size = new System.Drawing.Size(192, 21);
            this.txtLeather.TabIndex = 7;
            // 
            // label1
            // 
            ...
            this.Name = "FrmLeather";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "皮种信息维护";
            this.Load += new System.EventHandler(this.FrmLeather_Load);
        ...
        #endregion
        private void FrmLeather_Load(object sender, EventArgs e)
        {
        ...
        private void save()
        {
            ...
            else
            {
                if (M_int_judge == 0)
                {
                    dt1 = boperate.getdt("select Leather from tb_Leather where Leather='" + txtLeather.Text + "'");
                    if (dt1.Rows.Count > 0)
                    {
                        MessageBox.Show("皮种已经存在！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        boperate.getcom("insert into tb_Leather(Leather,Maker,Date) values('"
                                           + txtLeather.Text.Trim() + "','" + FrmLogin.M_str_name + "','" + varDate + "')");
                ...
                {
                    dt2 = boperate.getdt("select Leather from tb_Leather");
                    if (dt2.Rows.Count > 0)
                    {
                        boperate.getcom(@"update tb_Leather set Leather='" + txtLeather.Text + "',Maker='" + FrmLogin.M_str_name +
                         "',Date='" + varDate +
                         "' where Leather='" + Convert.ToString(dataGridView1[0, dataGridView1.CurrentCell.RowIndex].Value).Trim() + "'");
        ...
        {
            txtLeather.Text = Convert.ToString(dataGridView1[0, dataGridView1.CurrentCell.RowIndex].Value).Trim();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataSet myds = boperate.getds(M_str_sql + " where Leather like '%" + txtKeyWord.Text.Trim() + "%' order by Date asc", M_str_table);
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    boperate.getcom("delete from tb_Leather where Leather='" + Convert.ToString(dataGridView1[0, dataGridView1.CurrentCell.RowIndex].Value).Trim() + "'");
                    Bind();
                }
            }
            catch (Exception ex)
