...
{
    public partial class frmWareInfoP : Form
    {
...
END  AS 可用否,Maker as 制单人,Date as 日期 from tb_WareInfo  ";
        ...
        #endregion
        private void frmWareInfoP_Load(object sender, EventArgs e)
        {
            Bind();
        }
        ...
        private void ac()
        {
           ...
           else  if (!boperate.exists("SELECT * FROM TB_WAREINFO WHERE WAREID='" + txtWareID.Text + "'"))
            {
             ...
             else if (bc.getOnlyString("WNAME", "tb_wareinfo", txtWareID.Text ) != txtWName .Text  ||
                 bc.getOnlyString("ExternalM", "tb_wareinfo", txtWareID.Text) != cmbExternalM.Text ||
                 bc.getOnlyString("type", "tb_wareinfo", txtWareID.Text) != cmbType.Text ||
               bc.getOnlyString("Leather", "tb_wareinfo", txtWareID.Text) != cmbLeather.Text ||
                 bc.getOnlyString("color", "tb_wareinfo", txtWareID.Text) != cmbColor.Text ||
               bc.getOnlyString("StitchingC", "tb_wareinfo", txtWareID.Text) != cmbStitchingC.Text ||
               bc.getOnlyString("detail", "tb_wareinfo", txtWareID.Text) != cmbDetail.Text ||
                 bc.getOnlyString("Thickness", "tb_wareinfo", txtWareID.Text) != cmbThickness.Text)
            {
  ...
  + "',ExternalM='" + cmbExternalM.Text + "',Type='" + cmbType.Text + "',Detail='" + cmbDetail.Text + "',Leather='" + cmbLeather.Text +
  "', Color='" + cmbColor.Text + "',StitchingC='" + cmbStitchingC.Text + "', Thickness='" + cmbThickness.Text + "',Maker='" + FrmLogin.M_str_name +
  "',Date='" + varDate + "' where WareID='" + txtWareID.Text.Trim() + "'");
                    if (cmbACTIVE.Text == "Y" || cmbACTIVE.Text == "N")
                    {
                        boperate.getcom(@"update tb_WareInfo set ACTIVE='" + cmbACTIVE.Text + "' where WareID='" + txtWareID.Text.Trim() + "'");
                    }
                    Bind();
