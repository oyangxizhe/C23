...
{
    public partial class FrmStitchingC : Form
    {
        ...
        protected string M_str_sql = "select StitchingC as 线色,Maker as 制单人,Date as 日期 from tb_StitchingC";
        protected string M_str_table = "tb_StitchingC";
        protected int M_int_judge, i;
        protected int getdata;

        public FrmStitchingC()
        {
            InitializeComponent();
        }
        #region init
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmStitchingC));
            this.dataGridView1 = new System.Windows.Forms.DataGridView();
            this.groupBox1 = new System.Windows.Forms.GroupBox();
            this.txtStitchingC = new System.Windows.Forms.TextBox();
            ...
            this.dataGridView1.Size = new System.Drawing.Size(943, 501);
            ...
            this.groupBox1.Controls.Add(this.txtStitchingC);
            ...
            this.groupBox1.Text = "线色信息";
            // 
            // txtStitchingC
            // 
            this.txtStitchingC.Location = new System.Drawing.Point(81, 20);
            this.txtStitchingC.Name = "txtStitchingC";
            this.txtStitchingC.Size = new System.Drawing.Size(192, 21);
            this.txtStitchingC.TabIndex = 7;
            // 
            // label1
            // 
            ...
            this.Name = "FrmStitchingC";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "线色信息维护";
            this.Load += new System.EventHandler(this.FrmStitchingC_Load);
        ...
        private void FrmStitchingC_Load(object sender, EventArgs e)
        {
        ...
        private void save()
        {
            ...
            if (txtStitchingC.Text == "")
            {
                MessageBox.Show("线色不能为空！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                if (M_int_judge == 0)
                {
                    dt1 = boperate.getdt("select StitchingC from tb_StitchingC where StitchingC='" + txtStitchingC.Text + "'");
                    if (dt1.Rows.Count > 0)
                    {
                        MessageBox.Show("线色已经存在！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        boperate.getcom("insert into tb_StitchingC(StitchingC,Maker,Date) values('"
                                           + txtStitchingC.Text.Trim() + "','" + FrmLogin.M_str_name + "','" + varDate + "')");
                        Bind();
                ...
                {
                    dt2 = boperate.getdt("select StitchingC from tb_StitchingC");
                    if (dt2.Rows.Count > 0)
                    {
                        boperate.getcom(@"update tb_StitchingC set StitchingC='" + txtStitchingC.Text + "',Maker='" + FrmLogin.M_str_name +
                         "',Date='" + varDate + "' where StitchingC='" + Convert.ToString(dataGridView1[0, dataGridView1.CurrentCell.RowIndex].Value).Trim() + "'");
                        Bind();
                    }
                    else
                    {
        ...
        {
            txtStitchingC.Text = Convert.ToString(dataGridView1[0, dataGridView1.CurrentCell.RowIndex].Value).Trim();
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    boperate.getcom("delete from tb_StitchingC where StitchingC='" + Convert.ToString(dataGridView1[0, dataGridView1.CurrentCell.RowIndex].Value).Trim() + "'");
                    Bind();
                }
            }
            catch (Exception ex)
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataSet myds = boperate.getds(M_str_sql + " where StitchingC like '%" + txtKeyWord.Text.Trim() + "%' order by Date asc", M_str_table);
