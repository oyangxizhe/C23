...
A.IFMRP_CALCULATE AS IFMRP_CALCULATE,
A.PURCHASE_GODE AS PURCHASE_GODE,
A.WORKORDER_GODE AS WORKORDER_GODE,
A.WORKORDER_SCRAP AS WORKORDER_SCRAP,
A.WORKORDER_MATERIEL_SCRAP AS WORKORDER_MATERIEL_SCRAP,
...
";
        string setsqlth = @"
UPDATE STORAGEINFO SET 
STORAGEID=@STORAGEID,
STORAGENAME=@STORAGENAME,
IFMRP_CALCULATE=@IFMRP_CALCULATE,
PURCHASE_GODE=@PURCHASE_GODE,
WORKORDER_GODE=@WORKORDER_GODE,
WORKORDER_SCRAP=@WORKORDER_SCRAP,
WORKORDER_MATERIEL_SCRAP=@WORKORDER_MATERIEL_SCRAP,
DATE=@DATE,
MAKERID=@MAKERID,
YEAR=@YEAR,
MONTH=@MONTH
